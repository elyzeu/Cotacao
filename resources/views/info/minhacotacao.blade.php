    ...
    <x-slot name="header">
        ...
        @else
            <div class="search-container">
                ...
                <input id="descricao" class="aux" placeholder="Insira o ID do Pedido" type="text" name="descricao" />
...
@endif
    ...
    <tr data-type="header">
        <th>ID Pedido</th>
        <th>Status</th>
        <th class=" icoalign">Editar</th>
        <th class=" icoalign">Excluir</th>
    ...
    <tr class="trh">
        ...
        <td class="editbtn icoalign">
            <button class="edit-button" data-id="{{ $pedido->id }}">
                <i class="fas fa-pencil-alt"></i>
            </button>
        </td>
        <td class="editbtn icoalign">
            <form action="{{ route('DeleteMinhaCotacao', $pedido->id) }}" method="GET">
                @csrf
                @method('DELETE')
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Adicione um manipulador de eventos de clique a cada botão "Visualizar Itens"
        viewItemsButtons.forEach(function (button) {
            button.addEventListener('click', function () {
                ...
                // Abra o modal correspondente aos itens do pedido com base no ID
                var itemsModal = document.getElementById('itemsModal' + pedidoId);
                itemsModal.style.display = 'block';

                // Adicione aqui a lógica para preencher o modal com os itens do pedido apropriados
            });
        });
